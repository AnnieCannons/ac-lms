...
- A human friendly feature title in kebab-case (e.g. confidence-tracker-graph)
- A safe git branch name not already taken (e.g. claude/feature/confidence-tracker-graph)
