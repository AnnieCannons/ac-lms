          ...
          {done ? (
            ...
            <>
              ...
              <form onSubmit={handleSubmit} className="flex flex-col gap-5">
                <div>
                  <label htmlFor="new-password" className="block text-sm font-medium text-dark-text mb-1">New Password</label>
                  <p id="new-password-desc" className="text-xs text-muted-text mb-1.5">Min 8 characters with uppercase, lowercase, a number, and a symbol (e.g. !, @, #, $)</p>
                ...
                <div>
                  <label htmlFor="confirm-password" className="block text-sm font-medium text-dark-text mb-1">Confirm Password</label>
                  <div className="relative">
                    <input
                      id="confirm-password"
