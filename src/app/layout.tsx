  ...
  return (
    <html lang="en" suppressHydrationWarning>
      ...
      >
        ...
        <a
          href="#main-content"
          className="absolute left-2 -top-20 focus:top-2 z-[100] bg-surface border border-teal-primary text-teal-primary px-4 py-2 rounded-lg text-sm font-medium transition-[top]"
        >
