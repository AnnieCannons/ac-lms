...
export default function InstructorCourseNav({ courseId, courseName }: Props) {
  ...
  return (
    <nav className="flex flex-col">
      <p
        className="text-[10px] font-bold text-muted-text uppercase tracking-widest mb-4 px-3 truncate"
        title={courseName}
      >
        {courseName}
      </p>
      ...
      <div className="flex flex-col gap-0.5">
        ...
        <p className="text-[10px] font-bold text-muted-text uppercase tracking-widest mt-4 mb-1 px-3">Grades</p>
