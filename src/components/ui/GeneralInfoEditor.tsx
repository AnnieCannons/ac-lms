...
function SectionCard({
  ...
  if (editing) {
    return (
      <div className="bg-surface rounded-2xl border border-teal-primary p-5 flex flex-col gap-4">
        <input
          type="text"
          value={title}
  ...
  return (
    <div className="bg-surface rounded-2xl border border-border p-5 group relative">
